...
export const genderOptions = [
  ...
  export const sidebarOptions=[
    {name:"Home",url:"/dashboard",key:"tab1",img:"/sidebar_home.png"},
    {name:"Recording List",url:"/recording-list",key:"tab2",img:"/sidebar_record.png"},
  ]
...
export const fields: Field[] = [
  { id: "phoneNumber", placeholder: "Mobile Number", type: "tel" },
    ...
    { id: "streetAddress", placeholder: "Street Address", type: "text" },
